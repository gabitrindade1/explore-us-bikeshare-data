...
def get_city():
    ...
    while city not in ['chicago', 'new york city', 'washington']:
        city = input('Invalid option! Please, choose a valid city:  ').strip().lower()
    print('--> The city option {} has been successfully registered...'.format(city))
...
def get_month():
    ...
    while month not in ['all', 'january', 'february', 'march', 'april', 'may', 'june']:
        month = input('Invalid option! Please, choose a valid month:  ').strip().lower()
    print('--> The month option {} has been successfully registered...'.format(month))
...
def get_day():
    ...
    while day not in ['all', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday']:
        day = input('Invalid option! Please, choose a valid day:  ').strip().lower()
    print('--> The day option {} has been successfully registered...'.format(day))
